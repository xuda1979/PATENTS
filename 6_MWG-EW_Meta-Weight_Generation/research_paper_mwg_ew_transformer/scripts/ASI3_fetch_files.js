...
process.env.HUANXIN_PROFILE_COPY_NAME = process.env.HUANXIN_PROFILE_COPY_NAME || 'mwg-ew-ASI3-fetch';
...
if (process.env.ASI3_ALLOW_BROWSER !== '1') {
  console.error(
    'Refusing to run ASI3_fetch_files.js because it opens Huanxin browser automation. ' +
...
function parseArgs(argv) {
  const args = {
    chunkBytes: parseInt(process.env.ASI3_FETCH_CHUNK_BYTES || '1200', 10),
    pairs: [],
  };
