...
REMOTE_LAUNCHER="$PROJECT_ROOT/scripts/launch_asi3_token_router_global_suite_balanced_1npu_detached.sh"
LOCAL_LAUNCHER="$ROOT_DIR/scripts/launch_asi3_token_router_global_suite_balanced_1npu_detached.sh"
...
IFS=$'\n'
set -f
SPLIT_TEXT_REL_PATHS=($SPLIT_TEXT_OUTPUT)
set +f
IFS="$OLD_IFS"
