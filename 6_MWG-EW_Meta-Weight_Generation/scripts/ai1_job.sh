...
SHELL_WRAPPER="$ROOT_DIR/scripts/ai1_shell.sh"
...
usage() {
  cat >&2 <<'EOF'
Usage:
  scripts/ai1_job.sh start <job-name> <log-path> "<remote command>"
  scripts/ai1_job.sh status <job-id> [tail-lines]
  scripts/ai1_job.sh logs <job-id> [tail-lines]
